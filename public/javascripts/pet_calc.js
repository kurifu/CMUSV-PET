...
function validate_rate(){
    ...
    if("" == document.getElementById("deliverable_production_rate").value){
        ...
        document.getElementById("check_rate").src = "/images/default.png"
            ...
            if(""==document.getElementById("deliverable_production_rate").value)
                {
                    document.getElementById("deliverable_estimated_size")
                    .disabled="false"
...
function calculate(){
    ...
    else if(!("" == document.getElementById("deliverable_estimated_size")
            .value) &&
            !("" == document.getElementById("deliverable_estimated_effort")
            .value) &&
                !("" == document.getElementById("deliverable_production_rate")
            .value)){
                document.getElementById("calc")
        .innerHTML = "Please remove one of the three values for correct calculation";
            }
    else{
         document.getElementById("calc")
        .innerHTML = "";
